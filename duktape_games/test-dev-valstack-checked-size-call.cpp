...
TEST_F(FooTest,test_dev_valstack_checked_size_call)
{
	run_tests({ test_ecma_call_success,
		test_ecma_call_error,
		test_ecma_pcall_success,
		test_ecma_pcall_error,

		test_c_call_success,
		test_c_call_error1,
		test_c_call_error2,
		test_c_pcall_success,
		test_c_pcall_error1,
		test_c_pcall_error2,

		test_safe_call_success,
		test_safe_call_error1,
