...
static void register_dump_buffer_info(duk_context *ctx) {
	duk_eval_string_noresult(ctx,
		...
		"    print(typeof v, Object.prototype.toStringall(v), v.length, v.byteOffset, v.byteLength, v.BYTES_PER_ELEMENT, typeof v.buffer);\n"
...
static duk_ret_t test_view_buffer_prop(duk_context *ctx) {
	...
	duk_eval_string(ctx,
		...
		"    print(pd.value, pd.writable, pd.enumerable, pdonfigurable);\n"
		"    print(Object.prototype.toStringall(v.buffer));\n"
...
//
//	(test_basic);
//	(test_view_buffer_prop);
//	(test_unaligned);
//	(test_unaligned_uneven);
//	(test_uncovered);
//	(test_invalid_index1);
//	(test_invalid_index2);
//	(test_invalid_bufferobject);
//	(test_invalid_string);
//	(test_invalid_null);
//	(test_invalid_flags1);
//	(test_invalid_flags2);
...
//	(test_invalid_offlen_wrap2);
//	(test_allowed_offlen_nowrap1);
//
...
TEST_F(FooTest,test_push_buffer_object)
{
