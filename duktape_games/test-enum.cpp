...
static duk_ret_t test_1(duk_context *ctx) {
	...
	duk_eval_string(ctx, "(function () { var o = Objectreate({ parent: 'inherited' }); o.foo = 'bar'; return o; })()");
	duk_enum(ctx, -1, 0 /*enum_flags*/);  /* [ obj enum ] */
	while (duk_next(ctx, -1 /*enum_index*/, 1 /*get_value*/)) {
		printf("key: '%s', value: '%s'\n", duk_get_string(ctx, -2), duk_to_string(ctx, -1));
		duk_pop_2(ctx);
	...
	duk_eval_string(ctx, "(function () { var o = Objectreate({ parent: 'inherited' }); "
