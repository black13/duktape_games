...
static duk_ret_t test_gc_variants(duk_context *ctx) {
	void *p, *new_p;
...
static duk_ret_t test_raw_variants(duk_context *ctx) {
	void *p, *new_p;
...
static duk_ret_t test_mixed_use(duk_context *ctx) {
	void *p, *new_p;
...
TEST_F(FooTest, test_memory_funcs)
{
	run_tests({ test_raw_variants, test_gc_variants, test_mixed_use });
}
