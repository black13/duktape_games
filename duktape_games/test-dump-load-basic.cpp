...
typeof .prototypeonstructor: function
.prototypeonstructor === func: true
descriptor of .prototype: {"value":{},"writable":true,"enumerable":false,"configurable":false}
descriptor of .prototypeonstructor: {"writable":true,"enumerable":false,"configurable":true}
final top: 0
==> rc=0, result='undefined'
===*/
...
static duk_ret_t test_properties(duk_context *ctx) {
	...
	duk_eval_string(ctx,
		...
		"    print('typeof .prototypeonstructor: ' + typeof v.prototypeonstructor);\n"
		"    print('.prototypeonstructor === func: ' + (v === v.prototypeonstructor));\n"
		"    print('descriptor of .prototype: ' + JSON.stringify(Object.getOwnPropertyDescriptor(v, 'prototype')));\n"
		"    print('descriptor of .prototypeonstructor: ' + JSON.stringify(Object.getOwnPropertyDescriptor(v.prototype, 'constructor')));\n"
		"})");
	duk_dup(ctx, -2),
	duk_call(ctx, 1);
	duk_pop(ctx);
...
static duk_ret_t test_arguments_object(duk_context *ctx) {
	duk_eval_string(ctx,
		...
		"        print(typeof arguments, Object.prototype.toStringall(arguments));\n"
...
BOOST_AUTO_TEST_CASE( test-dump-load-basic
