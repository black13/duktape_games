...
static duk_ret_t test_3(duk_context *ctx) {
	...
	duk_eval_string(ctx, "Number.prototype.myfunc1 = function() { print(typeof this, this, Object.prototype.toStringall(this)); };");
	duk_pop(ctx);
	duk_eval_string(ctx, "Number.prototype.myfunc2 = function() { 'use strict'; print(typeof this, this, Object.prototype.toStringall(this)); };");
	duk_pop(ctx);
